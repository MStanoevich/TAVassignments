...
public interface CarInterface {
	...
	/*
	 * Method Description:
	 * Method used to turn on the car since it depends on its actuator,
	 * If the actuator is on, the car can move forward, detect next left lane and change lane
	 * If the actuator is off, the car is off

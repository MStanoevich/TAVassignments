...
public class Car implements CarInterface {
	...
	@Override
	public boolean ActuatorIsOn() throws StreetLengthException {
	...
	public void moveForward() throws StreetLengthException {
		if(!ActuatorIsOn()){
			System.out.println("The car can't move forward while off.");
			return;
		}
	...
	public void changeLane(UltrasoundSensor r1, UltrasoundSensor r2, UltrasoundSensor r3, Lidar l1)
		...
		if(!ActuatorIsOn()){
			System.out.println("The car can't change lane while off.");
			return;
		}
	...
	public Position whereIs() throws StreetLengthException {
		if(!ActuatorIsOn()){
			System.out.println("The car can't return location while off.");
			throw new StreetLengthException("The car can't return location while off."); //Make new excetion
		}
